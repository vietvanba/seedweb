...
<body>
	<nav class="navbar navbar-expand-sm bg-secondary navbar-dark">
		<ul class="navbar-nav">
			...
			<li class="nav-item"><a class="nav-link"
				href="home/about.htm?language=en" data-lang="en"><img alt=""
					src="https://uis.ptithcm.edu.vn/App_Themes/Standard/Images/US.gif"></a></li>
			<li class="nav-item"><a class="nav-link"
				href="home/about.htm?language=vi" data-lang="vi"><img alt=""
	...
	<div id="over" class="container">
		<h3><s:message code="global.aboutus" /></h3>
		<img alt="Viet Seed" src="images/logo3.png"
			style="width: 35%; height: 35%"> <br>
		<p class="text-center">
		<s:message code="global.noidung" />
		<br>
		<s:message code="global.company" />
		<br>
		<s:message code="global.giayphep" />
		<br>
		<s:message code="global.by" />
	</p>
	</div>
