...
<body>
	...
	<div class="container">
		...
		<c:choose>
			<c:when test="${Seeds == null}">
				<div class="alert alert-danger">Bạn không có hạt nào cả</div>
			</c:when>
			<c:otherwise>
				<table class="table table-striped">
					...
					<thead>
						<tr>
							<th>Mã loại</th>
							<th style="text-align: center;">Tên hạt</th>
							<th style="text-align: center;">Số lượng</th>
							<th style="text-align: center;">Sửa</th>
						</tr>
					</thead>
					<tbody>
						<c:forEach var="o" items="${Seeds}">
							<tr>
								<td>${o.getIdSeed()}</td>
								<td style="text-align: center;">${o.getSeedName()}</td>
								<td style="text-align: center;">${o.getNumber()}</td>
								<td style="text-align: center;"><a
									href="admin/updateseed/${o.getIdSeed()}.htm">Sửa</a></td>
		...
		<a href="admin/seedinsert.htm" class="btn btn-success">Thêm mới</a>
	</div>
