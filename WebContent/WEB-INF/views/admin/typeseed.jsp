...
<body>
	...
	<div class="container">
		...
		<c:choose>
			<c:when test="${TypeSeeds == null}">
				<div class="alert alert-danger">Bạn không có loại hạt nào cả</div>
			</c:when>
			<c:otherwise>
				<table class="table table-striped">
					...
					<tbody>
						<c:forEach var="o" items="${TypeSeeds}">
							<tr>
								<td>${o.getIdTypeSeed()}</td>
								<td style="text-align: center;">${o.getTypeSeedName()}</td>

								<td style="text-align: center;"><a
									href="admin/updatetypeseed/${o.getIdTypeSeed()}.htm">Sửa</a></td>
		...
		<a href="admin/inserttypeseed.htm" class="btn btn-success">Thêm mới</a>
	</div>
