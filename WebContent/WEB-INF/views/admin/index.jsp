...
<body>
	...
	<table class="table table-striped">
		...
		<tbody>
			<c:forEach var="o" items="${admin}">
				<tr>
					<td style="text-align: center;">${o.getUsername()}</td>
					<td style="text-align: center;">${o.getLastName()}
						${o.getFirstName()}</td>
					<td style="text-align: center;"><c:if test="${o.getAdmin()==false}">Không là Admin</c:if><c:if test="${o.getAdmin()==true}">Là Admin</c:if></td>
					<td style="text-align: center;"><c:if test="${o.getAdmin()==false}"><a href="admin/addAdmin/${o.getIdUser()}.htm">Thêm quyền Admin</a></c:if><c:if test="${o.getAdmin()==true}"><a href="admin/cancelAdmin/${o.getIdUser()}.htm">Huỷ quyền Admin</a></c:if> </td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
