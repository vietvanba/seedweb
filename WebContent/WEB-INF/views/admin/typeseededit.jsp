...
<body>
	...
	<br>
		...
		<form:form action="admin/updatetypeseed/${typeseed.getIdTypeSeed()}.htm" modelAttribute="typeseed">
			<label style="color: red;">${message}</label>
			<div class="form-group">
				<label>Tên loại hạt:</label>
				<form:input cssClass="form-control" path="typeSeedName" />
				<form:errors path="typeSeedName"/>
			</div>
			<div>
				<button class="btn btn-success">Sửa</button>
				<a class="btn btn-info" href="admin/deletetypeseed/${typeseed.getIdTypeSeed()}.htm">Xoá</a>
			</div>
