...
<body>
	...
	<div class="container" style="width: 700px">
		...
		<form:form action="admin/updateseed/${seed.getIdSeed()}.htm"
			modelAttribute="seed" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<form:select path="typeSeed.idTypeSeed" items="${TypeSeeds}"
					itemLabel="typeSeedName" itemValue="idTypeSeed" />
			</div>
			<div class="form-group">
			...
			<div>
				...
				<a class="btn btn-info" href="admin/deleteseed/${seed.getIdSeed()}.htm">Xoá</a>
			</div>
