	...
	<nav class="navbar navbar-expand-sm bg-secondary navbar-dark">
		<ul class="navbar-nav">
			...
			<li class="nav-item"><a class="nav-link"
				href="TypeSeed/${Seed.get(0).getTypeSeed().getIdTypeSeed()}.htm?language=en" data-lang="en"><img alt=""
					src="https://uis.ptithcm.edu.vn/App_Themes/Standard/Images/US.gif"></a></li>
			<li class="nav-item"><a class="nav-link"
				href="TypeSeed/${Seed.get(0).getTypeSeed().getIdTypeSeed()}.htm?language=vi" data-lang="vi"><img alt=""
