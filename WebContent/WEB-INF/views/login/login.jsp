...
<body>
	<nav class="navbar navbar-expand-sm bg-secondary navbar-dark">
		<ul class="navbar-nav">
			...
			<li class="nav-item"><a class="nav-link"
				href="home/login.htm?language=en" data-lang="en"><img alt=""
					src="https://uis.ptithcm.edu.vn/App_Themes/Standard/Images/US.gif"></a></li>
			<li class="nav-item"><a class="nav-link"
				href="home/login.htm?language=vi" data-lang="vi"><img alt=""
	...
	<div class="container" style="width: 700px">
		...
		<form:form action="home/login.htm" modelAttribute="user">
			...
			<s:message code="global.remeberpass" />
			</label>
			<div>
