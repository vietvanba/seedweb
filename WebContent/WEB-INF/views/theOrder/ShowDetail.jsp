...
<body>
	<nav class="navbar navbar-expand-sm bg-secondary navbar-dark">
		<ul class="navbar-nav">
			...
			<li class="nav-item"><a class="nav-link"
				href="order/showDetail/${orderDetail.get(0).getTheOrder().getIdOrder()}.htm?language=en" data-lang="en"><img alt=""
					src="https://uis.ptithcm.edu.vn/App_Themes/Standard/Images/US.gif"></a></li>
			<li class="nav-item"><a class="nav-link"
				href="order/showDetail/${orderDetail.get(0).getTheOrder().getIdOrder()}.htm?language=vi" data-lang="vi"><img alt=""
	...
	<div class="container">
		<br>
		<h3>
			<s:message code="global.detailOrder" />
		</h3>
		...
		<table class="table table-striped">
			...
			<thead>
				<tr>
					...
					<th style="text-align: center;"><s:message code="global.price" /></th>

					<th style="text-align: center;"><s:message code="global.total" /></th>
			...
			<tbody>
				...
				<tr>
					<td><s:message code="global.totalPrice" /></td>
